-- Script simplificado para corregir las tablas staff y appointments
-- Ejecutar directamente en el SQL Editor de Supabase

-- Crear función para actualizar el timestamp si no existe
...
-- PARTE 2: TABLA APPOINTMENTS
-- Crear la tabla appointments si no existe
CREATE TABLE IF NOT EXISTS public.appointments (
    id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
    title TEXT NOT NULL DEFAULT 'Cita sin título',
    start_time TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT NOW(),
    end_time TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT (NOW() + INTERVAL '1 hour'),
...
ALTER TABLE public.appointments 
    ADD COLUMN IF NOT EXISTS title TEXT DEFAULT 'Cita sin título',
